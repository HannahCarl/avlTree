/*Hannah Posch
* HW 6, Summer 2018
* The code will build an Avl tree and then as the tree needs balancing, the code will call the additional
* functions added for a single and double rotation of the right child.
* The textbook, Data Structures and Algorithm Analysis in Java, was consulted for this project.
*/

import java.util.*;

// AvlTree class - UPDATED
//
...
public class AvlTree<AnyType extends Comparable<? super AnyType>> 
{
    ...
    /******************** @author Hannah Posch *************/
    /*
	 * rotateWithRightChild : Rotate binary tree node with right child.
     * Update heights, then return new root. 
	 * @param: an AvlNode
	 ...
	 */
 	...
 	/*
	 * doubleWithRightChild : The method first completes a rotate with the left child
	 * then calls an additional method to perform a rotate with the right child.
	 * @param: an AvlNode
	 * @return: new root node
	 */
 	...
 	/*
	 * doubleWithRightChildVersion2 : The method first completes a rotate with the left child
	 * then performs a rotate with the right child internally. The method also updates the nodes' heights.
	 * @param: an AvlNode
	 * @return: new root node
	 */
 	private AvlNode<AnyType> doubleWithRightChildVersion2(AvlNode<AnyType> k2) {
 			AvlNode<AnyType> k1 = k2.right;
	 		AvlNode<AnyType> k3 = k1.left;
	        k1.left = k3.right;
	        k3.right = k1;
	        k1.height = Math.max( height( k1.left ), height( k1.right ) ) + 1;
	        k3.height = Math.max( height( k3.left ), k3.height ) + 1;
	        k2.right = k3;
	        AvlNode<AnyType> k4 = k2.right;
	        k2.right = k4.left;
	        k4.left = k2;
	        k2.height = Math.max( height( k2.left ), height( k2.right )) + 1;
	        k4.height = Math.max( height( k4.right), k2.height ) + 1;
	        return k4;
 			
 		}
 	/******************** end of @author Hannah Posch portion*************/
     ...
     */
    private void printTreeLevelOrder(AvlNode<AnyType> node) {
    	System.out.println("\n============ Start of tree ============");
        if (node == null) {
           System.out.print(" - ");
        }
          ...
          Queue<AvlNode<AnyType>> thisLevel = new LinkedList<>();
          //Queue that holds the nodes on the next level
          Queue<AvlNode<AnyType>> nextLevel = new LinkedList<>(); 
